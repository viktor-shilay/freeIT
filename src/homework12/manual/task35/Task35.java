...
public class Task35 {
    public static void main(String[] args) {
        ...
        int sum = 0;
        try (DataOutputStream dos = new DataOutputStream(new BufferedOutputStream(new FileOutputStream("task35.txt")))) {
        ...
        try (DataInputStream dis = new DataInputStream(new BufferedInputStream(new FileInputStream("task35.txt")))) {
            while (true) {
                int i = dis.readInt();
                System.out.print(i + " ");
                sum += i;
